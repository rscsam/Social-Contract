...
//                    fbProfilePictureView.setProfileId(fbUserId);
                    getFBPic(AccessToken.getCurrentAccessToken(), fbUserId, container);
...
//        params.put("socialContractId", userID);
//        JsonObjectRequest jsonObjectRequest2 = new JsonObjectRequest(Request.Method.POST, url2, new JSONObject(params2),
//                new Response.Listener<JSONObject>() {
//                    @Override
//                    public void onResponse(JSONObject response) {
//                        System.out.println(response);
//                        try {
//                            //set facebook profile
//                            twUserId = response.getJSONArray("accounts").getJSONObject(0).getString("facebookId");
//                            twAccessToken = response.getJSONArray("accounts").getJSONObject(0).getString("accessToken");
//
//                        } catch (JSONException e) {
//                            Toast.makeText(getActivity(), "Failure parsing JSON", Toast.LENGTH_SHORT).show();
//                        }
...
//        queue.add(jsonObjectRequest2);
    ...
    private void getFBPic(AccessToken accessToken, String fbUserId, final ViewGroup container) {
        String graphPath = "/" + fbUserId + "/picture";
        Bundle params = new Bundle();
        params.putBoolean("redirect", false);
        GraphRequest request = new GraphRequest(
                accessToken, graphPath, params, HttpMethod.GET,
                new GraphRequest.Callback() {
                    ...
                    public void onCompleted(GraphResponse response) {
                        ...
                        try {
                            ...
                            Bitmap profilePic = BitmapFactory.decodeStream(picUrl.openStream());
